...
class Float:
    ...
    # methods to retrieve some specific float instances:
    ...
    def __repr__(self):
        """
        Return the canonial decimal string representation of a float.
        """
        return repr(self.bin_to_float(self.binary))

    def __str__(self):
        """
        Return the most readable string representation of a float.
        """
